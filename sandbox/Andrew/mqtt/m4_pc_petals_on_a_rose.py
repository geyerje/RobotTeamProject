...
"""  # TDONE: 1. PUT YOUR NAME IN THE ABOVE LINE.
...
# DOE: 3. Create a method named guess_response within MyDelegate.
...
def main():
    # ODNE: 4. Create a my_delegate object from your MyDelegate class
...
def guess(mqtt_client, number_to_guess_entry):
    ...
    mqtt_client.send_message("guess", [number_to_guess_entry.get()])
